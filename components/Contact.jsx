        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4">
            <div className="lg:p-4 h-full ">
              ...
              <div>
                <h2 className="py-2">PHAM NHAT TIEN</h2>
                <p>Front-End Developer</p>
                <p className="py-2">
                  I am available for freelance or full-time positions. Contact
                  me and let&apos;s talk.
                </p>
                <div className="py-1 flex text-xl">
                  <FaPhoneAlt className="mt-1 mr-5" />{" "}
                  <p className="font-semibold "> 096 527 34 94</p>
                </div>
              </div>
              <div>
                ...
                <div>
                  <p className="uppercase pt-8">View more project</p>
                  <a
                    href="https://github.com/TienPham98"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <div className=" flex rounded-full shadow-lg shadow-gray-400 p-6 cursor-pointer hover:scale-110 ease-in duration-300">
                      <FaGithub className="mt-1 mr-5" />
                      <p>https://github.com/TienPham98</p>
                    </div>
                  </a>
                </div>
              </div>
          ...
          <div className="col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4">
            <div className="p-4">
              <form
                action="https://getform.io/f/aaf4f212-62f4-40f0-a20b-266cb1c27ca1"
                method="POST"
